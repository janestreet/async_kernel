...
(* OASIS_START *)
(* DO NOT EDIT (digest: e7f8d672ece8a00f3d72d7b6de28a98f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          findlib_version = Some (OASISVersion.VGreaterEqual "1.2.7");
          name = "async_core";
          version = "108.07.01";
          license =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\0013\173R\168\004(O\151q?\218\129\210\216\164";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
