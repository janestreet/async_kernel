(* OASIS_START *)
(* DO NOT EDIT (digest: edf637a9a9c6caf6c24bbcc447a85f7a) *)
(*
...
let setup_t =
  {
     ...
     test = [];
     doc = [("async_core", OCamlbuildDocPlugin.doc_build "lib")];
     install = InternalInstallPlugin.install;
     uninstall = InternalInstallPlugin.uninstall;
     clean = [OCamlbuildPlugin.clean];
     clean_test = [];
     clean_doc = [("async_core", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
     package =
       {
          ...
          copyrights =
            [
               "(C) 2008-2013 Jane Street Capital LLC <opensource@janestreet.com>"
            ];
          maintainers =
            ["Jane Street Capital LLC <opensource@janestreet.com>"];
          authors = ["Jane Street Capital LLC <opensource@janestreet.com>"];
          homepage = Some "https://github.com/janestreet/async_core";
          synopsis =
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("core",
                               Some (OASISVersion.VGreaterEqual "109.22.00"));
                           FindlibPackage
                             ("fieldslib",
                           ...
                           FindlibPackage
                             ("pa_ounit",
                               Some (OASISVersion.VGreaterEqual "109.18.00"));
                           ...
                           FindlibPackage
                             ("zero",
                               Some (OASISVersion.VGreaterEqual "109.21.00"))
                        ];
                      bs_build_tools =
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "async_core";
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Jane street's async library (core)";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\215\020\138\166i\031O>\175\238\211H\178D\031a";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
