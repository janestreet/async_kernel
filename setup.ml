(* OASIS_START *)
(* DO NOT EDIT (digest: 0c7d6d0a19af89504ba9eb03a1b3c9b7) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("herelib", None);
                           FindlibPackage ("herelib.syntax", None)
                        ];
                      bs_build_tools =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\002\2498\131S\160\209\019\170\132{\180]\234\216y";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
