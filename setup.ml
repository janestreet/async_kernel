(* OASIS_START *)
(* DO NOT EDIT (digest: 74636f947b5cff6056d7567028287a2b) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("core",
                               Some (OASISVersion.VGreaterEqual "109.19.00"));
                           FindlibPackage
                             ("fieldslib",
                               Some (OASISVersion.VGreaterEqual "109.19.00"));
                           ...
                           FindlibPackage
                             ("sexplib",
                               Some (OASISVersion.VGreaterEqual "109.17.00"));
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\028i\150m\028\202\006*\030G/y\255\b\b\017";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
