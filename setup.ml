(* OASIS_START *)
(* DO NOT EDIT (digest: 55ee4417f5940c0d7e8965250e2473f3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some "Jane Street Capital's asynchronous execution library";
          categories = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\245e\003\018\190\176\249\219\000ro=\195\019|\023";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
