...
(* All functions have identical behavior to their [Deferred_array] counter-part. *)
...
let mapi ~how t ~f = unsafe_to_array t |> Deferred_array.mapi ~how ~f >>| unsafe_of_array
